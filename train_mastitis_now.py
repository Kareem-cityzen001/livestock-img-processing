"""
Quick training script for Mastitis - ASCII only for Windows console.
Trains 10 epochs on 4-class dataset.
"""
...
class QuickMastitisTrainer:
    ...
    def train_epoch(self, model, train_loader, criterion, optimizer):
        ...
        for batch_idx, (images, labels) in enumerate(train_loader):
            ...
            if (batch_idx + 1) % 50 == 0:
                pct = 100 * (batch_idx + 1) / batch_count
                print(f"{int(pct):3d}%...", end=" ", flush=True)
                sys.stdout.flush()
    ...
    def train(self, epochs=10, data_path="datasets/train"):
        ...
        for epoch in range(epochs):
            print(f"Epoch [{epoch+1:2d}/{epochs}] Training: ", end="", flush=True)
            sys.stdout.flush()
            ...
            print(f"\n    Train: Loss={train_loss:.4f}, Acc={train_acc:.1f}% ({int(train_time)}s)")
...
if __name__ == "__main__":
    print("\n" + "="*70)
    print("MASTITIS MODEL TRAINING")
    print("="*70)
    print("""
Quick training script - 10 epochs on 4-class dataset

Classes:
  - Mastitis (positive)
  - Healthy (negative)
  - Lumpy (other disease)  
  - Foot-and-mouth (other disease)
""")
